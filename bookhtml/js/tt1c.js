...
function tt1cCall(){
	...
	*This file uses kineticJS to create each object.*/
	...
	/*creates an event each time a circle is clicked or tapped. Calls upon tt1csetColor() function in functions.js
	*for devices with a mouse device, the click function is used. For touch devices such as mobile and tablet devices, the tap function is used.*/
	...
	function tt1cupdateTable()
	{
		...
		if(errors==0){
			...
			if(tt1ccircle3Array.length<4||tt1ccircle4Array.length<4||tt1ccircle5Array.length<4||tt1ccircleArray.length<12)
			{
